...
If our goal is to reduce the number of predictors in the data, we can use the first 5 columns of principal component scores as our transformed predictors. However, it is important to keep in mind that PCA only focuses the linear relationships between the original variables, and any information in nonlinear relationships is not captured. 
