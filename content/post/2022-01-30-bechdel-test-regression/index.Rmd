...
The primary objective of this analysis was to understand which factors explain the difference between a films' Bechdel test rating by building a logistic regression model with Bechdel test rating as the main outcome of interest. 
